...
#ifndef _REFLECT_PATH_TRACING_INL_HPP_
#define _REFLECT_PATH_TRACING_INL_HPP_
...
PathTracing<kSampleSize>::PathTracing(RendererSystem& system,
...
void PathTracing<kSampleSize>::render(RendererSystem& system)
{
...
/*!
  ...
  */
template <std::size_t kSampleSize> inline
Ray PathTracing<kSampleSize>::generateRay(const std::size_t x, 
                                          const std::size_t y,
                                          Sampler& sampler,
                                          MemoryPool& memory_pool,
...
/*!
  ...
  */
template <std::size_t kSampleSize> inline
void PathTracing<kSampleSize>::initialize(const QSettings& /* settings */)
{
}
...
/*!
  ...
  */
template <std::size_t kSampleSize>
Ray PathTracing<kSampleSize>::sampleNextRay(const std::size_t path_length,
                                            const Ray& ray,
                                            const ShaderPointer& bxdf,
                                            const IntersectionInfo& intersection,
                                            Sampler& sampler,
...
/*!
  ...
  */
template <std::size_t kSampleSize> inline
void PathTracing<kSampleSize>::traceCameraPath(RendererSystem& system)
{
...
#endif // _REFLECT_PATH_TRACING_INL_HPP_
