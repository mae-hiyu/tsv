...
class TSVLightPathTracing : public RenderingMethod<kSampleSize>
{
 public:
  ...
  using SamplesLight = typename Method::SamplesLight;


  //! Create a TSVLightPathTracing instance
  TSVLightPathTracing(RendererSystem& system,
