/*!
  \file      tsv-probabilistic_ppm-inl.hpp
  \author    takemura
  #2016/01/11
  */
...
TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::TSVProbabilisticPpm(
...
void TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::render(
    RendererSystem& system)
{
  photon_map_.clear();
  updateRadius();
  ...
  SampledWavelengths<kSampleSize> sampled_wavelengths = Method::sampleWavelengths(sampler);
  ...
  // SampledWavelengths<kSampleSize> sampled_wavelengthsXYZ;
  ...
  // std::size_t wavelengthX = sampled_wavelengthsX.wavelengths()[0];
  // std::size_t wavelengthY = sampled_wavelengthsY.wavelengths()[0];
  // std::size_t wavelengthZ = sampled_wavelengthsZ.wavelengths()[0];
  // sampled_wavelengthsXYZ.set(0, wavelengthX,sampled_wavelengthsX.inverseProbabilities()[0]/3);
  // sampled_wavelengthsXYZ.set(1, wavelengthY,sampled_wavelengthsY.inverseProbabilities()[0]/3);
  // sampled_wavelengthsXYZ.set(2, wavelengthZ,sampled_wavelengthsZ.inverseProbabilities()[0]/3);
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping>
auto TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::estimateRadiance(
    const int thread_id,
    const Vector3& vin,
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping> inline
void TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::evaluateImplicitConnection(
    const Ray& ray,
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping> inline
auto TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::generatePhoton(
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping> inline
Ray TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::generateRay(
    const std::size_t x,
    const std::size_t y,
    Sampler& sampler,
    MemoryPool& memory_pool,
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping> inline
bool TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::hasPhotonMapMaterial(
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping>
void TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::initialize(
    RendererSystem& system,
    const QSettings& settings)
{
  pass_ = 0;
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping>
void TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::initializeFilterKernel(
    const QSettings& settings,
    const QString& key)
{
  ...
  if (type_hash == zisc::toHash32(keyword::no_kernel)) {
    ...
    zisc::raiseError("TSVProbabilisticPpmError: Unsupported kernel type is specified.");
  }
}
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping> inline
auto TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::sampleNextPhoton(
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping> inline
Ray TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::sampleNextRay(
    const Ray& ray,
    const ShaderPointer& bxdf,
    const IntersectionInfo& intersection,
    Sampler& sampler,
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping> inline
void TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::tracePhoton(
    RendererSystem& system,
    const Samples& sampled_wavelengthsXYZ)
{
  ...
  for (std::size_t i = 0; i < light_source_list.size(); ++i) {
    ...
    tracePhoton(system, i, sampled_wavelengthsXYZ, light_source.object(),num_of_photons);
  }
    ...
    const std::size_t num_of_photons)
{
  ...
  [this, &system, &sampled_wavelengthsXYZ, light_source, thread_photons, scale_factor]
  (const int thread_id, const std::size_t)
  {
    tracePhoton(system, thread_id, sampled_wavelengthsXYZ, 
...
void TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::tracePhoton(
    ...
    const double scale_factor)
{
  const auto& wavelengths = sampled_wavelengthsXYZ.wavelengths();


  // WavelengthSamples<kSampleSize> wavelengths;

  // wavelengths.setXYZwavelength(std::get<0>(sampled_wavelengthsXYZ).wavelengths()[0], 0);
  // wavelengths.setXYZwavelength(std::get<1>(sampled_wavelengthsXYZ).wavelengths()[0], 1);
  // wavelengths.setXYZwavelength(std::get<2>(sampled_wavelengthsXYZ).wavelengths()[0], 2);

  // const auto wavelength_weight = makeSampledSpectra<kSampleSize>(sampled_wavelengthsXYZ);
  ...
  for (std::size_t number = 0; number < num_of_photons; ++number) {
    Spectra photon_energy{sampled_wavelengthsXYZ.wavelengths()};
    // Spectra photon_energy{wavelengths};
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping> inline
void TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::traceRay(
    RendererSystem& system,
    const Samples& sampled_wavelengthsXYZ)
{
  auto& sampler = system.globalSampler();
  ...
  [this, &system, &sampled_wavelengthsXYZ](const int thread_id, const std::size_t y) 
  {
    traceRay(system, thread_id, y, sampled_wavelengthsXYZ);
  }};
    ...
    const Samples& sampled_wavelengthsXYZ)
{
  ...
  const auto& wavelengths = sampled_wavelengthsXYZ.wavelengths();
  const auto wavelength_weight = makeSampledSpectra(sampled_wavelengthsXYZ);
  // WavelengthSamples<kSampleSize> wavelengths;
...
/*!
  ...
  */
template <std::size_t kSampleSize, bool kEnableGlossyMapping> inline
void TSVProbabilisticPpm<kSampleSize, kEnableGlossyMapping>::updateRadius()
{
  ++pass_;
