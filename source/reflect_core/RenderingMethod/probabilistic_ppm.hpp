...
class ProbabilisticPpm : public RenderingMethod<kSampleSize>
{
 public:
  ...
  //! Creaet a ProbabilisticPPM instance
   ProbabilisticPpm(RendererSystem& system, 
 ...
 private:
  ...
  void tracePhoton(RendererSystem& system, const Samples& sampled_wavelengths);
  ...
  void traceRay(RendererSystem& system, const Samples& sampled_wavelengths);
